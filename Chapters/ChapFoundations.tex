...
The sounds [\ipa{r, R, x, G, h, H}] are called rhotics because they represent sounds which are somehow related to the letter ``r'' -- ``rho'' in Greek. Although some of these sounds are quite different in terms of phonetics, phonologically they have shown to behave similarly in many languages \cite{Wiese2001}.
...
\normalsize [\ipa{r,x,G,h,H}] & amo[\ipa{r,x,G,h,H}] & amor & love & strong-r \\
\normalsize [\ipa{r,x,G,h,H}] & dan\c{c}a[\ipa{r,x,G,h,H}] & dan\c{c}ar & to dance & strong-r \\
...
\normalsize [\ipa{r,x,G,h,H}] & mo[\ipa{r,x,h}]to & morto & dead & strong-r \\
\normalsize [\ipa{r,x,G,h,H}] & po[\ipa{r,x,h}]co & porco & pig & strong-r \\
\normalsize [\ipa{r,x,G,h,H}] & mo[\ipa{r,X,H}]da & morda.VERB & bite & strong-r \\
\normalsize [\ipa{r,x,G,h,H}] & ca[\ipa{r,X,H}]ga & carga & load & strong-r \\
...
Apart from the rhotic fricatives, \ac{BP} has six more fricative sounds: [\ipa{f, v, s, z, S, Z}]. The first two are named labiodental because they are produced in such way that the lips touch the upper teeth. As other fricative sounds, for the phones [\ipa{f, v}], the air does not passes freely in the vocal tract, on contrary it finds obstacles thus generating turbulance. 
...
Part of this system was evaluated by \citet{Wang2014} \citep{Wang2014} in a \ac{CAPT} context, by testing the
