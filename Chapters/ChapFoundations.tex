...
\normalsize [\ipa{k}] & [k]ato & cato & duck & voiceless velar plosive \\
\normalsize [\ipa{g}] & [g]ato & gato & cat & voiced velar plosive \\ \hline
\end{tabular}
...
\normalsize [\ipa{d}] & [\ipa{at.}]$\sim$[\ipa{a.di.}]$\sim$[\ipa{a.dZi.}]ministrar & administrar & to manage & voiced alveolar/postalveolar plosive \\
...
\normalsize [\ipa{r,\*r,G,H}] & mo[\ipa{r,\*r,G,H}]da & morda.VERB & bite & strong-r \\
...
\normalsize [\ipa{s}] & po[\ipa{s}]$\sim$[\ipa{S}]tar & postar & to post & voiceless bilabial plosive \\
\normalsize [\ipa{s}] & ca[\ipa{s}]$\sim$[\ipa{S}]tor & castor & beaver & voiced bilabial plosive \\
\normalsize [\ipa{z}] & de[\ipa{z}]$\sim$[\ipa{Z}]gaste & desgaste & wear and tear & voiceless alveolar plosive \\
\normalsize [\ipa{z}] & tran[\ipa{z}]$\sim$[\ipa{Z}]gressivo & transgressivo & transgressive.MASC & voiced alveolar plosive \\ \hline
\end{tabular}
